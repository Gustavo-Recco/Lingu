...
IDIOMAS = {
    "en": {
        ...
        "frases": [
            {"frase": "I ___ a student.",             "resposta": "am",      "opcoes": ["am","is","are","be"]},
            {"frase": "She ___ to school every day.", "resposta": "goes",    "opcoes": ["go","goes","going","gone"]},
            {"frase": "They ___ playing football.",   "resposta": "are",     "opcoes": ["is","am","are","be"]},
            {"frase": "He ___ not like coffee.",      "resposta": "does",    "opcoes": ["do","does","did","have"]},
            {"frase": "I have ___ this movie.",       "resposta": "watched", "opcoes": ["watch","watches","watching","watched"]},
        ],
    ...
    "es": {
        ...
        "frases": [
            {"frase": "Yo ___ estudiante.",            "resposta": "soy",   "opcoes": ["soy","es","son","ser"]},
            {"frase": "Ella ___ a la escuela.",        "resposta": "va",    "opcoes": ["va","van","voy","ir"]},
            {"frase": "Ellos ___ jugando futbol.",     "resposta": "estan", "opcoes": ["esta","estoy","estan","ser"]},
            {"frase": "El no ___ cafe.",               "resposta": "toma",  "opcoes": ["tomo","toma","toman","tomar"]},
            {"frase": "Yo he ___ esta pelicula.",      "resposta": "visto", "opcoes": ["ver","veo","visto","veia"]},
        ],
